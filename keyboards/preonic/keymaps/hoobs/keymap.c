...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_LOWER] = {
    { KC_ESC , _______, _______, _______, _______ , _______, _______, _______, _______, _______, _______, LALT(LCTL(KC_DEL))},
    { _______, _______, _______, _______, _______ , _______, _______, _______, _______, _______, _______, _______},
    { KC_DEL, _______, _______, _______,  KC_MPRV , _______, _______, KC_MNXT, _______, _______, _______, _______},
    { _______, _______, _______, _______, _______ , _______, _______, _______, _______, _______, _______, _______},
