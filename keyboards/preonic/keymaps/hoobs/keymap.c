...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_LOWER] = {
    { KC_ESC , _______, _______, _______, _______ , _______, _______, _______, KC_F10, KC_F11, KC_F12, LALT(LCTL(KC_DEL))},
    { _______, _______, _______, _______, _______ , _______, _______, _______, KC_F7 , KC_F8, KC_F9, KC_VOLU},
    { KC_DEL, _______, _______, _______,  KC_MPRV , _______, _______, KC_MNXT, KC_F4 , KC_F5 , KC_F6 , KC_VOLD},
